...
torch.save(train_bach_latents, "latents/train_bach_latents.pt")
torch.save(train_beethoven_latents, "latents/train_beethoven_latents.pt")
torch.save(train_brahms_latents, "latents/train_brahms_latents.pt")
torch.save(train_cambini_latents, "latents/train_cambini_latents.pt")
torch.save(train_dvorak_latents, "latents/train_dvorak_latents.pt")
torch.save(train_faure_latents, "latents/train_faure_latents.pt")
torch.save(train_haydn_latents, "latents/train_haydn_latents.pt")
torch.save(train_mozart_latents, "latents/train_mozart_latents.pt")
torch.save(train_ravel_latents, "latents/train_ravel_latents.pt")
torch.save(train_schubert_latents, "latents/train_schubert_latents.pt")

# Save individual composer latents - VALIDATION
torch.save(val_bach_latents, "latents/val_bach_latents.pt")
torch.save(val_beethoven_latents, "latents/val_beethoven_latents.pt")

# Save individual composer latents - TEST
torch.save(test_bach_latents, "latents/test_bach_latents.pt")
torch.save(test_brahms_latents, "latents/test_brahms_latents.pt")
torch.save(test_cambini_latents, "latents/test_cambini_latents.pt")
torch.save(test_faure_latents, "latents/test_faure_latents.pt")
torch.save(test_haydn_latents, "latents/test_haydn_latents.pt")
torch.save(test_mozart_latents, "latents/test_mozart_latents.pt")
torch.save(test_ravel_latents, "latents/test_ravel_latents.pt")
torch.save(test_schubert_latents, "latents/test_schubert_latents.pt")

# Save combined latents (for backward compatibility)
torch.save(train_jazz_latents, "latents/train_jazz_latents.pt")
torch.save(train_classical_latents, "latents/train_classical_latents.pt")
